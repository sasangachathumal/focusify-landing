...
import featureImg from "../../public/features/feature-1.png";
  ...
  return (
    <div className="w-full flex flex-col md:flex-row items-center py-5">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute top-0 right-0 w-xl h-xl blob-3 bg-red-600/80 animate-float -z-1"></div>
        <div className="absolute top-0 right-0 w-2xl h-2xl blob-3 bg-red-600/20 animate-float -z-1"></div>
      </div>
